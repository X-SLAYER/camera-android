...
public class SensorOrientationFeatureTest {
    ...
    public void before() {
        ...
        mockedStaticDeviceOrientationManager
                .when(() -> DeviceOrientationManager.create(mockContext, mockActivity, mockDartMessenger, false, 0))
    ...
    public void ctor_shouldStartDeviceOrientationManager() {
        SensorOrientationFeature sensorOrientationFeature =
                new SensorOrientationFeature(mockCameraProperties, mockContext, mockActivity, mockDartMessenger);
